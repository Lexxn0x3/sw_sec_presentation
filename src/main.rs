...
fn main() {
    ...
    //https://www.techzine.eu/news/devops/117333/google-new-code-written-in-memory-safe-languages-like-rust/
    //https://thehackernews.com/2024/04/critical-batbadbut-rust-vulnerability.html
    
    //Begin with static types.
    //Variables immutable by default -> no accidental modification.
    //static_types::i32_in_i64(); // It's a static type language cant even auto cast i32 into i64
    //static_types::signedness(); //Basically fixes the signedness problem due to explicitly
    ...
    //borrowing::copy_move_clone_book(); //Recap some types are copy. Some types aren't. If I want a copy I can deep clone.
    ...
    //println!("{}", lifetime_tracking::get_first_word("Hello, world")); //Lifetime is inferred. No free after use needed.
    //println!("{}", lifetime_tracking::longest("Hello", "world")); //Lifetime is annotated. No free after use needed.
    ...
    //portability, performance, file size, shared library in memory
